...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250923231148_SrsCardStateRefactor")]
    partial class SrsCardStateRefactor
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Infrastructure.Data.Model.EventTable", b =>
                {
                    b.HasOne("Infrastructure.Data.Model.CardTable", null)
                        .WithMany("Events")
                        .HasForeignKey("CardTableId");
                });
